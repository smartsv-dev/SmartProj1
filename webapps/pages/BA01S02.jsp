...
<head>
  ...
  <link rel="apple-touch-icon-precomposed" href="${pageContext.request.contextPath}/image/app-icon72x72@2x.png">
...
<script src="${pageContext.request.contextPath}/javascript/amazeui.ie8polyfill.min.js"></script>
<![endif]-->

<!--[if (gte IE 9)|!(IE)]><!-->
<script src="${pageContext.request.contextPath}/javascript/jquery.min.js"></script>
<!--<![endif]-->
<script src="${pageContext.request.contextPath}/javascript/amazeui.min.js"></script>
